        ...
        <div class="max-w-3xl mx-auto bg-slate-100 py-5 rounded-lg shadow-4xl ">
            <div class="max-w-2xl mx-auto">
                <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <x-form.input post="new \App\Http\Models\Post" field="title" type="text" />
                    <x-form.input post="new \App\Http\Models\Post" field="excerpt" type="text" />
                    ...
                    <x-form.input post="new \App\Http\Models\Post" field="image" type="file" />
