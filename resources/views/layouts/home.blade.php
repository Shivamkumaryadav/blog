                ...
                <div id="navbar-link" class="flex gap-10">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex font-semibold items-center px-3 py-3 border border-transparent text-sm leading-4  rounded-md text-black bg-gray-200 hover:bg-gradient-to-r from-[#F8586D] to-[#EB287D] hover:text-white focus:outline-none transition ease-in-out duration-150">
                    ...
                    <div class="md:hidden">
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button
                                class="w-full text-center  px-3 py-2 bg-gray-200  hover:bg-gradient-to-r from-[#F8586D] to-[#EB287D] font-semibold rounded-lg hover:cursor-pointer hover:text-white"
